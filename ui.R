...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem("Triplet Analysis", tabName = "fttPage", icon = icon("dashboard")),
    menuItem("User Defined Blocks", tabName = "fttPage", icon = icon("dashboard"))
  )
)
...
#                                                          actionButton("runTests", "Run Tests")
#                                                        ),
#                                                        strong(em("Combinations that will be run:")),
#                                                        htmlOutput("generatedCombos")
#                                                 )
#                                               )
#                               )              
#                             )
